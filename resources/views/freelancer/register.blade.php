...
<head>
    ...
    <title>Registration | Freelancer</title>
            ...
            <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                ...
                <div class="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
                    <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                        <li>
                            <a href="{{ route('advertiser.register.form') }}" class="block py-2 pr-4 pl-3 text-white rounded bg-primary-700 lg:bg-transparent lg:text-primary-700 lg:p-0 dark:text-white" aria-current="page">광고주</a>
                        </li>
                        <li>
                            <a href="{{ route('freelancer.register.form') }}" class="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700">프리랜서</a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <section class="bg-gray-50 dark:bg-gray-900">
        <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-20 lg:py-16 lg:grid-cols-12">
            <div class="w-full p-6 mx-auto bg-white rounded-lg shadow dark:bg-gray-800 sm:max-w-xl lg:col-span-6 sm:p-8">
                ...
                <h1 class="mb-2 text-2xl font-bold leading-tight tracking-tight text-gray-900 dark:text-white">프리랜서 계정을 생성하세요</h1>
                <p class="text-sm font-light text-gray-500 dark:text-gray-300">
                    가입하고 SNS 광고로 수익을 창출하세요. 이미 계정이 있으신가요? <a href="{{ route('freelancer.login.form') }}" class="font-medium text-primary-600 hover:underline dark:text-primary-500">여기서 로그인하세요</a>.
                </p>
                <form class="mt-4 space-y-6 sm:mt-6" action="{{ route('freelancer.register') }}" method="POST">
                    @csrf
                    @if ($errors->any())
                    ...
                    <div class="space-y-3">
                        <div class="flex items-start">
                            <div class="flex items-center h-5">
                                <input id="terms" name="terms" type="checkbox" class="w-4 h-4 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-primary-300 dark:bg-gray-700 dark:border-gray-600 dark:focus:ring-primary-600 dark:ring-offset-gray-800" required>
                            </div>
                            <div class="ml-3 text-sm">
                                <label for="terms" class="font-light text-gray-500 dark:text-gray-300">
                                    회원가입을 완료하면 <strong>Logo 프리랜서 계정</strong>이 생성되며, <strong>Logo의</strong> <a href="#" class="font-medium text-primary-600 dark:text-primary-500 hover:underline">이용약관</a> 및 <a href="#" class="font-medium text-primary-600 dark:text-primary-500 hover:underline">개인정보 처리방침</a> 에 동의하는 것으로 간주됩니다. 광고 작업 및 수익 창출 조건도 포함됩니다.
                                </label>
                            </div>
                        </div>
                    </div>
                    <button type="submit" class="w-full text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">등록하고 수익을 시작하세요</button>
                </form>
            </div>
