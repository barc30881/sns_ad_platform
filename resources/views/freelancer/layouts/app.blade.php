...
<head>
    ...
    <meta name="keywords" content="Freelancer Dashboard">
            ...
            <nav class="offcanvas offcanvas-start" id="navbarNav" tabindex="-1" aria-labelledby="navbarNavLabel">
                ...
                <div class="offcanvas-body pt-2 pb-4 py-lg-0 mx-lg-auto">
                    <ul class="navbar-nav position-relative">
                        ...
                        <li class="nav-item py-lg-2 me-lg-n1 me-xl-0">
                            <a class="nav-link" href="{{ route('freelancer.ads') }}">새 게시물 만들기</a>
                        </li>
                    </ul>
                </div>
            </nav>
                    ...
                    <div class="offcanvas-lg offcanvas-start sticky-lg-top pe-lg-3 pe-xl-4" id="accountSidebar">
                        ...
                        <div class="offcanvas-body d-block pt-2 pt-lg-4 pb-lg-0">
                            <nav class="list-group list-group-borderless">
                                <a class="list-group-item list-group-item-action d-flex align-items-center {{ request()->routeIs('freelancer.dashboard') ? 'active' : '' }}" href="{{ route('freelancer.dashboard') }}">
                                    <i class="fi-layers fs-base opacity-75 me-2"></i>내 광고
                                </a>
                                <a class="list-group-item list-group-item-action d-flex align-items-center {{ request()->routeIs('freelancer.payment-settings') ? 'active' : '' }}" href="{{ route('freelancer.payment-settings') }}">
                                    <i class="fi-credit-card fs-base opacity-75 me-2"></i>결제 정보
                                </a>
                                <a class="list-group-item list-group-item-action d-flex align-items-center {{ request()->routeIs('freelancer.payment-history') ? 'active' : '' }}" href="{{ route('freelancer.payment-history') }}">
                                    <i class="fi-receipt fs-base opacity-75 me-2"></i>결제 내역
                                </a>
                                  <a class="list-group-item list-group-item-action d-flex align-items-center {{ request()->routeIs('freelancer.promotional-center') ? 'active' : '' }}" href="{{ route('freelancer.promotional-center') }}">
                                    <i class="fi-share fs-base opacity-75 me-2"></i>프로모션 센터
                                </a>
                                <form action="{{ route('freelancer.signout') }}" method="POST">
        @csrf
        <button type="submit" class="dropdown-item"><i class="fi-log-out opacity-75 me-2"></i>로그아웃</button>
