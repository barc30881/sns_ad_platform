        ...
        <nav class="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
            <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                ...
                <div class="flex items-center lg:order-2">
                    ...
                    <a href="#"
                        class="text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800">시작하기</a>
                ...
                <div class="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
                    <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                        <li>
                            <a href="./advertiserAuth.html"
                                class="block py-2 pr-4 pl-3 text-white rounded bg-primary-700 lg:bg-transparent lg:text-primary-700 lg:p-0 dark:text-white"
                                aria-current="page">광고주</a>
                        </li>
                        <li>
                            <a href="./freelancerAuth.html"
                                class="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700">프리랜서</a>
                        </li>
        ...
        <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-12 xl:gap-0 lg:py-16 lg:grid-cols-12">
            <div class="mr-auto place-self-center lg:col-span-7 xl:col-span-8">
                <h1
                    ...
                    후불로 광고 하세요 또는 1달러 부터 광고 하세요.</h1>
                <p class="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
트래픽을 유도하여 브랜드 인지도를 높이고 리드, 설치, 입금 등으로 전환하세요. 자동 최적화 기능을 활용하여 성과 KPI에 도달하고 ROI를 높이며 시간을 절약하세요.</p>
                 <div class="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-start sm:space-y-0 sm:space-x-4">
                <a href="{{ route('adApplicationPage') }}"
                    class="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900">
                    광고 시작하기
                    
                </a>
                <a href="{{ route('freelancer.ads') }}"
             ...
             <div class="flex justify-start items-start my-8 lg:my-16 divide-x divide-gray-200 dark:divide-gray-700">
                ...
                <a href="#" class="pl-3 text-gray-900 sm:pl-5 dark:text-white">
                    <svg class="h-6" viewBox="0 0 107 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path
                            ...
                            fill="#00B67A" />
                        <path d="M14.5035 13.0941L14.004 11.5194L10.4023 14.175L14.5035 13.0941Z" fill="#005128" />
                    </svg>
                    <span class="text-sm text-gray-500 dark:text-gray-400">최고로 평가됨 오버 <span
                            class="font-medium text-gray-900 dark:text-white">15.7k</span> 리뷰</span>
                </a>
            </div>
    ...
    <footer class="p-4 py-8 bg-white md:p-8 lg:p-10 dark:bg-gray-800">
        <div class="mx-auto max-w-screen-xl text-center">
            ...
            <div class="sm:items-center sm:justify-between sm:flex">
                    <a href="./index.html" class="flex items-center mb-4 text-2xl font-semibold text-gray-900 lg:mb-0 dark:text-white">
