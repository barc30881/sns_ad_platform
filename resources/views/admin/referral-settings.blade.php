...
<head>
    ...
    <title>추천 보너스 설정</title>
    <meta name="description" content="Manage referral bonuses">
    <meta name="keywords" content="admin, referral, bonuses">
            ...
            <nav class="offcanvas offcanvas-start" id="navbarNav" tabindex="-1" aria-labelledby="navbarNavLabel">
                ...
                <div class="offcanvas-body pt-2 pb-4 py-lg-0 mx-lg-auto">
                    <ul class="navbar-nav position-relative">
                        ...
                        <li class="nav-item py-lg-2 me-lg-n1 me-xl-0">
                            <a class="nav-link {{ request()->routeIs('admin.referral-settings') ? 'active' : '' }}" href="{{ route('admin.referral-settings') }}">추천 설정</a>
                        </li>
                    </ul>
                </div>
            </nav>
            <div class="d-flex gap-sm-1">
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" style="--fn-dropdown-spacer: .5rem">
                        ...
                        <li><a class="dropdown-item" href="{{ route('admin.dashboard') }}"><i class="fi-layers opacity-75 me-2"></i>대시보드</a></li>
                        <li><a class="dropdown-item" href="{{ route('admin.referral-settings') }}"><i class="fi-settings opacity-75 me-2"></i>추천 설정</a></li>
    ...
    <main class="content-wrapper">
        <div class="container pt-4 pt-sm-5 pb-5 mb-xxl-3">
            <div class="row pt-2 pt-sm-0 pt-lg-2 pb-2 pb-sm-3 pb-md-4 pb-lg-5">
                    ...
                    <div class="offcanvas-lg offcanvas-start sticky-lg-top pe-lg-3 pe-xl-4" id="accountSidebar">
                        ...
                        <div class="offcanvas-body d-block pt-2 pt-lg-4 pb-lg-0">
                            <nav class="list-group list-group-borderless">
                                <a class="list-group-item list-group-item-action d-flex align-items-center {{ request()->routeIs('admin.dashboard') ? 'active' : '' }}" href="{{ route('admin.dashboard') }}">
                                    <i class="fi-layers fs-base opacity-75 me-2"></i>대시보드
                                </a>
                                <a class="list-group-item list-group-item-action d-flex align-items-center {{ request()->routeIs('admin.ads') ? 'active' : '' }}" href="{{ route('admin.ads') }}">
                                    <i class="fi-file fs-base opacity-75 me-2"></i>광고 관리
                                </a>
                                <a class="list-group-item list-group-item-action d-flex align-items-center {{ request()->routeIs('admin.submissions') ? 'active' : '' }}" href="{{ route('admin.submissions') }}">
                                    <i class="fi-check fs-base opacity-75 me-2"></i>제출 관리
                                </a>
                                <a class="list-group-item list-group-item-action d-flex align-items-center {{ request()->routeIs('admin.users') ? 'active' : '' }}" href="{{ route('admin.users') }}">
                                    <i class="fi-users fs-base opacity-75 me-2"></i>사용자 관리
                                </a>
                                <a class="list-group-item list-group-item-action d-flex align-items-center {{ request()->routeIs('admin.payments') ? 'active' : '' }}" href="{{ route('admin.payments') }}">
                                    <i class="fi-credit-card fs-base opacity-75 me-2"></i>결제 관리
                                </a>
                                <a class="list-group-item list-group-item-action d-flex align-items-center {{ request()->routeIs('admin.referral-settings') ? 'active' : '' }}" href="{{ route('admin.referral-settings') }}">
                                ...
                                <form action="{{ route('admin.signout') }}" method="POST">
                                    ...
                                    <button type="submit" class="list-group-item list-group-item-action d-flex align-items-center">
                                        <i class="fi-log-out fs-base opacity-75 me-2"></i>로그아웃
                                    </button>
                                </form>
                            </nav>
                        </div>
                ...
                <div class="col-lg-9">
                    <h1 class="h2 pb-2 pb-lg-3">추천 보너스 설정</h1>
                    @if (session('success'))
                    ...
                    <div class="card border-0 shadow-sm">
                        <div class="card-body">
                            <form action="{{ route('admin.update-referral-bonus') }}" method="POST">
                                @csrf
                                <div class="mb-3">
                                    <label for="bonus_amount" class="form-label">추천당 보너스 금액 ($)</label>
                                    <input type="number" name="bonus_amount" id="bonus_amount" class="form-control" value="{{ $bonus->bonus_amount }}" step="0.01" min="0" required>
                                    @error('bonus_amount')
